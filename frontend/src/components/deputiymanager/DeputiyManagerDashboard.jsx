...
const DeputiyManagerDashboard = () => {
  return (
    <main id="main" className="main">
      <div className="pagetitle">
        <h1>DeputiyManager Dashboard</h1>
        <nav>
          <ol className="breadcrumb">
            <li className="breadcrumb-item"><a href="/">Home</a></li>
            <li className="breadcrumb-item active">DeputiyManager Dashboard</li>
          </ol>
        </nav>
      </div>
...
export default DeputiyManagerDashboard;
