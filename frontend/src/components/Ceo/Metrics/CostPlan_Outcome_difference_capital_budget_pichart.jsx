...
/**
 * CostPlanOutcomeDifferenceCapitalBudgetPieChart component fetches cost plan and outcome data
 * for the capital budget, processes the API response and renders a pie chart.
 *
 ...
 */
const CostPlanOutcomeDifferenceCapitalBudgetPieChart = ({ filters = {} }) => {
...
export default CostPlanOutcomeDifferenceCapitalBudgetPieChart;