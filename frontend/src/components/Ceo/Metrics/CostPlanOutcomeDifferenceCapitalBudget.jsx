...
/**
 * CostPlanOutcomeDifferenceCapitalBudget component fetches cost plan and outcome data
 ...
 */
const CostPlanOutcomeDifferenceCapitalBudget = ({ filters = {} }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const barLabels = ["Capital Budget"];
...
export default CostPlanOutcomeDifferenceCapitalBudget;