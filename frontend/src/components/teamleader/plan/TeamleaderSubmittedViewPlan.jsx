    ...
    <div className="supervisor-dashboard">
      ...
      {selectedPlan && (
        <div className="modal">
          ...
          <p><strong>Specific objective:</strong> {selectedPlan.specific_objective_name}</p>
          <p><strong>specific_obective_detailname:</strong> {selectedPlan.specific_obective_detailname}</p>
