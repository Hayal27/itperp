    ...
    <div className="plan-detail">
      ...
      {plan ? (
        <>
          ...
          <p><strong>Outcome:</strong> {plan.Outcome}</p>
          <p><strong>Execution Percentage:</strong> {plan.Execution_Percentage}</p>
          ...
          <p><strong>Quarter:</strong> {plan.Quarter}</p>
...
export default TeamleaderPlanDetail;
