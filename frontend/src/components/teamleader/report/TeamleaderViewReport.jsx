                      ...
                      {sortedPlans.map((plan) => (
                        <tr key={plan.ID}>
                          ...
                          <td>
                            ...
                            <Link to={`update/${plan.Plan_ID}`} className="btn btn-primary">
                              Update
                            </Link>
...
{showDetail && planDetail && (
  <div className="plan-detail-box">
    ...
    <p><strong>Outcome:</strong> {planDetail.Outcome}</p>
    <p><strong>Execution Percentage:</strong> {planDetail.Execution_Percentage}%</p>
...
export default TeamleaderViewPlan;
