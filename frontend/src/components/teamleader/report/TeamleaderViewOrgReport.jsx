...
{/* Display the report details in a large box (toggleable) */}
  ...
  <div className="plan-detail-box">
    ...
    <p><strong>Objective:</strong> {reportDetail.Objective}</p>
    <p><strong>Goal:</strong> {reportDetail.Goal}</p>
    ...
    <p><strong>Outcome:</strong> {reportDetail.Outcome}</p>
    <p><strong>Execution Percentage:</strong> {reportDetail.Execution_Percentage}%</p>
    ...
    <p><strong>Quarter:</strong> {reportDetail.Quarter}</p>
...
export default TeamleaderViewOrgReport;
