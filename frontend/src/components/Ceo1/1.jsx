...
const departmentsDetail = () => {
  ...
  useEffect(() => {
    Axios.get(`http://192.168.100.134:5000/api/plan/plan-applicant`)
  ...
  // Fetch applicants
  useEffect(() => {
    Axios.get("http://192.168.100.134:5000/getApplicant")
  ...
  // Fetch letters
  useEffect(() => {
    Axios.get("http://192.168.100.134:5000/api/letters/getLetters")
  ...
  // Fetch roles
  useEffect(() => {
    Axios.get("http://192.168.100.134:5000/getRole")
      .then((res) => setRole(res.data))
      .catch((err) => console.log(err));
  }, []);

  const [departments, setdepartments] = useState([]);
     Axios.get("http://192.168.100.134:5000/getdepartment")
