...
const ServiceHeadSubmittedViewPlan = () => {
  ...
  const fetchPlans = async () => {
    try {
      const response = await axios.get("http://192.168.100.134:5000/api/submitted_reports", {
...
export default ServiceHeadSubmittedViewPlan;
